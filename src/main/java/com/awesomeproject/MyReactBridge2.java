...
class MyReactBridge2 extends ReactContextBaseJavaModule {

    private final static String TAG = "MyReactBridge2";
    private static WeakReference<ReactApplicationContext> reactApplicationContextWeakReference;

    public MyReactBridge2(ReactApplicationContext reactApplicationContext) {
    ...
    public void handleBackButton() {
        QSDK.getInstance().dismissReactActivity();
    }

    @Override
    public String getName() {
        return "MyReactBridge2";
    }
}
